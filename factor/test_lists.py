...
def test_merge():
    ...
    assert result == expected_list # this will assure you that the concatonated list is equal to the expected list

    expected_length = len(list1) + len(list2) # this will show the length of the concatonated lists
    assert len(result) == expected_length # this will make sure that they are equal to each other
