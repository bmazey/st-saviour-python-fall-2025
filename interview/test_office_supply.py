...
def test_stapler():
    ...
    # thne 'assert' keyword checks if a condition is true. If it's not then the test fails 
    #  stapling 'p' to the front of 'anda' should result in 'panda' 
    assert staple_to_front('anda', 'p') == 'panda'
    # stapling 's' to the front of 'aviour' should result in 'saviour'.
    assert staple_to_front('aviour', 's') == 'saviour'

    # Verify that the staple_to_end function works correctly.
    # stapling 'a' to the end of 'pand' should result in 'panda'.
    assert staple_to_end('pand', 'a') == 'panda'
    #  r stapling 'r' to the end of 'saviou' should result in 'saviour'.
